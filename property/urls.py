...
urlpatterns = [
    ...
    path('detail/state=<str:state>&city=<str:city>&address=<str:address>&zip=<int:zip>&id=<str:propertyId>/&lat=<str:lat>&long=<str:long>/', views.property_detail_view, name='property_detail_coordinates'),
